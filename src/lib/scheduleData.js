export const scheduleData = [
  {
    ...
    list: [
      ...
      },
      {
        id: 5,
        date: "1:30 PM",
        vanu: "Traditional Heritage Ramp Walk",
        desc: "A vibrant showcase of India’s diverse cultural attire, bringing heritage to the runway.",
      },
      {
        id: 6,
        date: "3:00 PM",
        vanu: "Cultural Showcase Finale",
        desc: "Concluding our cultural segment, bidding adieu with an afternoon full of art and memories.",
      },
      {
        id: 7,
        date: "5:00 PM",
        vanu: "Concert Gates Open",
        desc: "Ticket checks and tagging as we prepare to kickstart the evening concert.",
      },
      {
        id: 8,
        date: "6:00 PM",
        vanu: "Iqlipse Nova Live Concert",
        desc: "Sing, dance, and groove to Iqlipse Nova’s electrifying tunes in an unforgettable live performance.",
      },
      {
        id: 9,
        date: "8:00 PM",
